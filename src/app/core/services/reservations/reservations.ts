...
export class Reservations {
  private reservations: Reservation[] = [
    ...
    },
    {
      id: 432,
      patientId: 67434,
      patientName: 'Romina Gatica',
      doctorId: 1,
      doctorName: 'Dr. Juan Pérez',
      date: '2025-12-13',
      time: '11:30',
      specialty: 'Control crónico',
      status: ReservationStatus.confirmada,
      reason: undefined,
    },
    {
